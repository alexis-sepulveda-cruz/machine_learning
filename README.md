# Aprendizaje Automático (Machine Learning) - Maestría en Ciencia de datos
...
## Notebooks
- [1. Data mining](./notebooks/data_mining.ipynb)
- [2. Regresión](./notebooks/2.regression.ipynb)
- [2. Clasificación](./notebooks/3.clasificacion.ipynb)
- [3. Evaluación](./notebooks/4.evaluacion.ipynb)
- [4. Clustering](./notebooks/5.clustering.ipynb)
