import pandas as pd
from practica2.regression.asset_simple_regression import AssetSimpleRegression
...
def simple_regression(df: pd.DataFrame):
    asset_reg = AssetSimpleRegression(df)
...
def experimental_regression(df: pd.DataFrame):
...
if __name__ == "__main__":
    ...
    asset_reg.linear_regression(df, Column.YEAR_MONTH, Column.APPLE_PRICE, perform_grid_search=True)
    print_separator()

    # Regresión lineal Ridge con búsqueda de cuadrícula
    asset_reg.ridge_regression(df, Column.YEAR_MONTH, Column.APPLE_PRICE, perform_grid_search=True)
    print_separator()

    # Regresión lineal Lasso con búsqueda de cuadrícula
    asset_reg.lasso_regression(df, Column.YEAR_MONTH, Column.APPLE_PRICE, perform_grid_search=True)
    print_separator()

    # Regresión polinomial con búsqueda de cuadrícula
    asset_reg.polynomial_regression(df, Column.YEAR_MONTH, Column.APPLE_PRICE, perform_grid_search=True)
    print_separator()

    # Regresión polinomial Ridge con búsqueda de cuadrícula
    asset_reg.polynomial_ridge_regression(df, Column.YEAR_MONTH, Column.APPLE_PRICE, perform_grid_search=True)
    print_separator()

    # Regresión polinomial Lasso con búsqueda de cuadrícula
    asset_reg.polynomial_lasso_regression(df, Column.YEAR_MONTH, Column.APPLE_PRICE, perform_grid_search=True)
    print_separator()

    # Regresión KNN con búsqueda de cuadrícula
    asset_reg.knn_regression(df, Column.YEAR_MONTH, Column.APPLE_PRICE, perform_grid_search=True)
    print_separator()

    # Regresión con árbol de decisión con búsqueda de cuadrícula
    asset_reg.decision_tree_regression(df, Column.YEAR_MONTH, Column.APPLE_PRICE, perform_grid_search=True)
    print_separator()
